...
//ol.proj.get("EPSG:4326").setExtent([22.892803, -23.204844, 38.367207, -14.834234]);
var wms_layers = [];
...
lyr_GoogleHybrid_0.setVisible(true);lyr_NationalProvincialboundaries_1.setVisible(true);lyr_GCFDistrics_2.setVisible(true);lyr_InnovationPlatforms_3.setVisible(true);lyr_HydrometInfrastructure_4.setVisible(true);lyr_IrrigationSchemeSites_5.setVisible(true);lyr_FarmerFieldSchoolsFFS_6.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_NationalProvincialboundaries_1,lyr_GCFDistrics_2,lyr_InnovationPlatforms_3,lyr_HydrometInfrastructure_4,lyr_IrrigationSchemeSites_5,lyr_FarmerFieldSchoolsFFS_6];
