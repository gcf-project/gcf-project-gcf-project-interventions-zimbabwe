...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 15, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [25.237434, -22.422557, 33.069820, -15.608035],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([22.892803, -23.204844, 38.367207, -14.834234], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GCF Building Climate Resilience of Vulnerable Agricultural Livelihoods in Southern Zimbabwe - Project Intervention Sites</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (165 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'The map shows the spatial distribution of the GCF Building Climate Resilience of Vulnerable Agricultural Livelihoods in Southern Zimbabwe Project Intervention Sites.';
            }
